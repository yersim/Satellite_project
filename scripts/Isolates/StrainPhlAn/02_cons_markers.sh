...
## Variables
indir=/scratch/syersin2/Satellite_scratch/Isolates/strainphlan/sams
outdir=/scratch/syersin2/Satellite_scratch/Isolates/strainphlan/consensus_markers
...
## Array variables
cd ${indir}
sample_name=$(ls | sed -n ${SLURM_ARRAY_TASK_ID}p | sed 's/\.sam\.bz2$//')
