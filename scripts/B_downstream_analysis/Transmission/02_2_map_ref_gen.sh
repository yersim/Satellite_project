...
bowtie2 --threads 16 \
	...
	-1 ${indir}/${sample_name}/${sample_name}_FASTP_BOWTIE2_R1_001.fastq.gz \
	-2 ${indir}/${sample_name}/${sample_name}_FASTP_BOWTIE2_R2_001.fastq.gz \
...
# Index the sorted BAM file (need to be with the .bam for inStrain profile)
