...
outdir=/scratch/syersin2/Satellite_scratch/comp_genomics/fastANI/fastANI_out_rvh

mkdir -p ${outdir}

cd ${genomes}
# Run fastANI
fastANI --ql ${refdir}/fastANI_list_rvh.txt \
    --rl ${refdir}/fastANI_list_rvh.txt \
    -o ${outdir}/RVH_fastANI.tsv \
    -t 8
