...
## Variables
depth_indir=/scratch/syersin2/Satellite_scratch/output_data/metaspades
...
#mkdir -p /users/syersin2/Satellite/output/A_upstream_output/${sample_name}/${sample_name}_depth
#cp ${depth_indir}/${sample_name}/${sample_name}_depth/*.depth /users/syersin2/Satellite/output/A_upstream_output/${sample_name}/${sample_name}_depth
